      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(55,201,126,0.1) 0%, transparent 68%)",
            filter: "blur(56px)",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(252,82,0,0.1) 0%, transparent 68%)",
            filter: "blur(56px)",
          }}
        />
        {/* Dot-grid texture */}
            ...
            {FEATURES.map(({ Icon, text }) => (
              <li key={text} className="flex items-center gap-3.5">
                <span
                  ...
                  style={{
                    background: "rgba(55,201,126,0.11)",
                    border: "1px solid rgba(55,201,126,0.2)",
                  }}
                >
